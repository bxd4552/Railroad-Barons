...
public class PlayerControlPane extends GridPane
    ...
    /**
     * Button label used when the {@link Player PlayerModel's} turn has begun and
    ...
    /**
     * Button label used when the current {@link Player PlayerModel's} turn has
    ...
    /**
     * Displays the current {@link Player PlayerModel's} hand of cards.
     */
