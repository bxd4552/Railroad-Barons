...
public class RailroadBaronsController implements RailroadMapObserver,
     ...
     *     <li>The specified class implements the MapMakerModel interface in the
     ...
     *     <li>The specified class implements the RailroadBaronsModel interface in
    ...
    void loadMap(String path) throws RailroadBaronsException {
        if(mapMaker == null) {
            throw new RailroadBaronsException(
                    "MapMakerModel has not been configured!");
        }
